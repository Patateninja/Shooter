...
class Crate
{
	...
	public :
		...
		virtual void Update(Player& _player, bool& _coffe, bool& _bmg, bool& _vest, BonusPopUp*& _popUp) = 0;
...
class BoostCrate : public Crate
{
	...
	public :
		...
		void Update(Player& _player, bool& _coffe, bool& _bmg, bool& _vest, BonusPopUp*& _popUp) override;
